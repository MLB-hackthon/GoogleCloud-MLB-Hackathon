...
function HomeRuns({ playerName }) {
  ...
  useEffect(() => {
    ...
    const fetchVideos = async () => {
      try {
        const response = await fetch(`http://34.56.194.81:8000/api/v1/content/videos/Aaron%20Judge/homeruns?limit=10&max_chars_title_en=50&max_chars_title_ja=30&max_chars_title_es=45`, {
          method: 'GET',
          headers: {
